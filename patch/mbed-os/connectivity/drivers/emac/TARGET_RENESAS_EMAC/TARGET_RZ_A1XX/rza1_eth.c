...
int ethernetext_init(rza1_ethernet_cfg_t *p_ethcfg)
{
    ...
    /* -->3F<-- P1_0(ET_RXD0), P1_1(ET_RXD1), P1_2(ET_RXD2) P1_3(ET_RXD3) */
    GPIOPMC1    |=  0x000F;
    GPIOPFCAE1  &= ~0x000F;
    GPIOPFCE1   |=  0x000F;
    GPIOPFC1    &= ~0x000F;
    ...
    /* -->4F<-- P3_0(ET_TXCLK), P3_1(ET_TXER), P3_2(ET_TXEN), P3_3(ET_RXCLK),
     *          P3_4(ET_RXER), P3_5(ET_RXDV), P3_6(ET_COL), P3_7(ET_CRS) */
    GPIOPMC3    |=  0x00FF;
    GPIOPFCAE3  &= ~0x00FF;
    GPIOPFCE3   |=  0x00FF;
    GPIOPFC3    |=  0x00FF;
    ...
    /* -->3F<-- P5_0(ET_TXD0), P5_1(ET_TXD1), P5_2(ET_TXD2), P5_3(ET_TXD3) */
    GPIOPMC5    |=  0x000F;
    GPIOPFCAE5  &= ~0x000F;
    GPIOPFCE5   |=  0x000F;
    GPIOPFC5    &= ~0x000F;
