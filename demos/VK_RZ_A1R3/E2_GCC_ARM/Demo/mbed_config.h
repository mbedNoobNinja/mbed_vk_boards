...
#define MBED_CONF_CAM_BOARD                                                   MBED_CONF_CAM_OV7725                                                                             // set by library:cam[VK_RZ_A1R3]
#define MBED_CONF_CAM_NONE                                                    CAMERA_NONE                                                                                      // set by library:cam
#define MBED_CONF_CAM_OV7725                                                  CAMERA_OV7725                                                                                    // set by library:cam
#define MBED_CONF_CAM_OV7740                                                  CAMERA_OV7740                                                                                    // set by library:cam
...
#define MBED_CONF_LCD_BOARD                                                   MBED_CONF_LCD_PANEL_NONE                                                                         // set by library:lcd
#define MBED_CONF_LCD_PANEL_NONE                                              0                                                                                                // set by library:lcd
...
#define MBED_CONF_LWIP_DEFAULT_THREAD_STACKSIZE                               640                                                                                              // set by library:lwip[RZ_A1XX]
...
#define MBED_CONF_LWIP_MEMP_NUM_TCP_SEG                                       32                                                                                               // set by library:lwip[RZ_A1XX]
#define MBED_CONF_LWIP_MEM_SIZE                                               51200                                                                                            // set by library:lwip[RZ_A1XX]
...
#define MBED_CONF_LWIP_PBUF_POOL_SIZE                                         16                                                                                               // set by library:lwip[RZ_A1XX]
...
#define MBED_CONF_LWIP_TCPIP_THREAD_STACKSIZE                                 1328                                                                                             // set by library:lwip[RZ_A1XX]
...
#define MBED_CONF_LWIP_TCP_MSS                                                1440                                                                                             // set by library:lwip[RZ_A1XX]
#define MBED_CONF_LWIP_TCP_SERVER_MAX                                         4                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_SND_BUF                                            (8 * TCP_MSS)                                                                                    // set by library:lwip[RZ_A1XX]
#define MBED_CONF_LWIP_TCP_SOCKET_MAX                                         4                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_SYNMAXRTX                                          6                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_WND                                                (TCP_MSS * 8)                                                                                    // set by library:lwip[RZ_A1XX]
...
#define MBED_CONF_PPP_THREAD_STACKSIZE                                        896                                                                                              // set by library:ppp[RZ_A1XX]
...
#define MBED_CONF_SDHI_CH                                                     1                                                                                                // set by library:sdhi[VK_RZ_A1R3]
#define MBED_CONF_SDHI_FSFAT_SDCARD_INSTALLED                                 1                                                                                                // set by library:sdhi
#define MBED_CONF_SDHI_TEST_BUFFER                                            8192                                                                                             // set by library:sdhi
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:RZ_A1XX
